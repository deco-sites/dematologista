          ...
          <div class="flex flex-col gap-4 md:flex-row justify-between mb-4 max-w-[400px]">
            {cta?.map((item) => (
              <a
                id={item.id}
                href={item.href}
                class="max-w-[180px] flex justify-center items-center bg-primary rounded-full text-white gap-1 py-3 px-8 hover:cursor-pointer transition-all hover:bg-[#363738]"
              >
                {item?.iconId && (
